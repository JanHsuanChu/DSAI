...
## <span style="color:#2563eb">📋 What This Rule Is</span>
...
When you (or the AI) create or update a README that matches the rule’s pattern, the rule is used to keep the doc short, scannable, and consistent: table of contents, blue section headers with icons, links to files, and compact brown flow diagrams where needed.
...
## <span style="color:#2563eb">📐 What It Asks For</span>
...
## <span style="color:#2563eb">✅ Quick Checklist</span>

Before considering a user-facing README done, the rule expects:

- [ ] TOC at top with anchor links
- [ ] Section headers: icon + blue (`<span style="color:#2563eb">...</span>`)
- [ ] Max 1000 words
